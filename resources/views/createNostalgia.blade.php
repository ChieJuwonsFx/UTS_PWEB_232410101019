...
<div class="min-h-screen bg--blue-50 py-8 px-4">
    <div class="max-w-2xl mx-auto">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Isi form berikut untuk menambah koleksi nostalgiamu yaaa</p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-[#1E376A] shadow-sm p-6 md:p-8">
            <form action="{{ route('pengelolaan.store', ['username' => $username]) }}" method="POST">
                ...
                <div class="text-center">
                    <button type="submit" class="w-full md:w-auto border border-[#1E376A] bg-[#1E376A] hover:bg-white text-white hover:text-[#1E376A] font-medium px-6 py-2 rounded-lg">
                        Simpan Nostalgia
                    </button>
                </div>
            </form>
